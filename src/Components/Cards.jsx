...
function Cards() {
    return (
        <div className='h-screen w-full px-5 lg:px-16 flex flex-col lg:flex-row gap-4 '>
            <div className='bg-[#004D43] w-full lg:w-2/4 h-[60%] rounded-xl text-[#CDEA68] relative '>
                <svg className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/4 h-1/4' width="82" height="40" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className='border-2 border-[#CDEA68] py-1 px-3 rounded-full absolute left-10 bottom-10'>&copy; 2019-2022</button>
            </div>
