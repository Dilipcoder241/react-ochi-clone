...
function Hero() {
    return (
        <div data-scroll data-scroll-speed="-.3" data-scroll-section className='h-[80vh]'>
            ...
            <div className="footer border-t-2 w-full border-[#7b7b7b] mt-[8vw] px-12 py-4 text-base flex items-center justify-between">
