...
function Footer() {
    return (
        <div className='min-h-screen flex flex-col lg:flex-row px-5 lg:px-20 pb-10'>
            <div className='text-[6vw] w-1/2 flex flex-col justify-between'>
                <div>
                    <h1 className='leading-none font-bold tracking-tighter'>EYE-</h1>
                    <h1 className='leading-none font-bold tracking-tighter'>OPENING</h1>
                </div>
            ...
            <div className="w-full lg:w-1/2">
                ...
                <div className='flex justify-between my-4'>
                    <div>
                    <h1 className='mb-6'>L:</h1>
                    <p className='w-2/3 mb-7 underline'>202-1965 W 4th Ave Vacouver , Canada</p>
                    <p className='w-2/3 underline'>30 Chukarina St Lviv, Ukraine</p>
                    
                    </div>
                    <div>
                    <h1 className='mb-6'>M:</h1>
                    <p className='underline'>Home</p>
                    <p className='underline'>Service</p>
                    <p className='underline'>Our Works</p>
                ...
                <h1 className='mb-4'>E:</h1>
                    <p className='underline'>helo@ochi.design</p>
                </div>

                <div className='mt-10 pb-5 flex items-center opacity-40 justify-between'>
                    <p>&copy; Dilip 2024 Legal Term</p>
                    <p>Website by Dilip</p>
                </div>
            </div>
        </div>
    )
