...
function Green() {
  return (
    <div className='bg-[#CDEA68] pt-1 pb-10'>
        ...
        <div className='w-full border-t-[2px] border-b-[2px] border-[#3333333c] py-5 px-14 flex items-center pb-20'>
            ...
            <div className='flex'>
                ...
                <div className="right w-1/2 flex items-center justify-center flex-col mt-20">
                    <div>
        ...
        <div className='flex items-center px-12 py-5 h-[75vh]'>
